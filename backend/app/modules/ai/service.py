...
Важно:
- если пользователь просит сводку по задачам с объектов, сначала дай общий итог, потом кратко по каждому объекту;
...
Для сводок по объектам используй такой порядок:
## 📊 Общий итог
...
def _build_provider_messages(
    *,
    ...
    messages.extend(
        ...
        for item in history[-AI_CONTEXT_HISTORY_LIMIT:]
    )
